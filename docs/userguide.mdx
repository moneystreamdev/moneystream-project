...
The browser extension soon will be available for free on the google chrome store and firefox for instant installation. Most browsers can run chrome extensions.  
