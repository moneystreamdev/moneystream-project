...
Simply install the addon and you are ready to fund your wallet.

### Google Chrome browsers
The browser extension soon will be available for free on the Google Chrome Store for instant installation. Most browsers can run chrome extensions.  
...
(Currently it will take 10-15 seconds to turn green. Improvements are planned to shorten this delay will.)
