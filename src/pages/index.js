...
const MoneyStream = () => (
  <div className="productShowcaseSection paddingBottom">
    <div style={{textAlign: "left"}}>
      <h1>Consider MoneyStream</h1>
      <div>&#x276F; The internet is a streaming medium. 
        MoneyStream is streamable money for the streaming web</div>
      ...
      <div>&#x276F; Use MoneyStream when you don't know how long you will be browsing content. 
        ...
        browser sessions.</div>
      <div>&#x276F; MoneyStream pays websites to remove ads from a browsing session</div>
      <div>&#x276F; MoneyStream pays content creators and platforms to access streamable content 
      ...
      <div>&#x276F; The user is happy paying for a clean content stream free from tracking ads 
        and extraneous noise.</div>
      <div>&#x276F; MoneyStream allows content platforms to be easily created. 
        One line of HTML code can enable monetization on a web site.</div>
      <div>&#x276F; MoneyStream provides an opportunity for everyone to earn bitcoin from 
        streaming web content.</div>
      ...
      <h1>How does MoneyStream apply to the BSV hackathon theme for a global "record of events"?</h1>  
      <div>&#x276F; MoneyStream monetizes events inside the browsers of a global internet population. 
        MoneyStream measures the exchange of value, captures the browser events and records them on 
        bitcoin at the end of the each browser session. 
        MoneyStream is a monetizer of a global record of events.</div>
      <div>&#x276F; The bitcoin miners protect the web sites from double spends, providing merchants 
        a safe operating environment to distribute content to anyone in the world. The web content 
        provider has assurance that they will get paid at the end of the user browser session.</div>
      ...
      <div>&#x276F; MoneyStream proves that the original and restored bitcoin is 
        instant safe global cash for everyone in the world.</div>
      <div>&#x276F; Instant cash payments allow for frictionless global trade on the web.</div>
